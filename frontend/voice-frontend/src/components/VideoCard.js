          ...
          <div className="left-controls">
            ...
            >
              <svg viewBox="0 0 24 24" width="20" height="20">
                ...
                <path fill="currentColor" d="M19 11a1 1 0 0 0-2 0 5 5 0 0 1-10 0 1 1 0 0 0-2 0 7 7 0 0 0 6 6.92V21a1 1 0 0 0 2 0v-3.08A7 7 0 0 0 19 11z"/>
              </svg>
            </button>
            <button className="icon-btn" onClick={onOpenTranscript} title="Transcript / History">
              <svg viewBox="0 0 24 24" width="20" height="20">
                <path fill="currentColor" d="M4 5h16v2H4zM4 11h16v2H4zM4 17h16v2H4z"/>
              </svg>
            </button>
          </div>
